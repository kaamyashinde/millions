...
public class FibonacciTool extends AbstractChartTool {
   ...
   * {@code AWAITING_SECOND} means the first pivot has been captured and the tool is waiting for the
   * second pivot click.
   */
  private enum State {
    IDLE,
  ...
  /**
   * Resets {@code state} to {@code AWAITING_SECOND}, clears any previous {@code firstPrice}, marks
   * the tool as active, and prompts the user to select the LOW pivot.
   *
