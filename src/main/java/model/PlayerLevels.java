...
/**
 * Canonical singleton references for each {@link PlayerLevel} state. Kept in a separate type so
 * the {@link PlayerLevel} interface does not initialize {@code NoviceLevel.INSTANCE} during its own
